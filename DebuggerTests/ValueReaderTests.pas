...
type
  ...
  public
    ...
    function  RunMethodCall(FuncVA: UInt64; const ArgValues: array of UInt64;
                const ArgIsFloat: array of Boolean; out RaxResult, Xmm0Low: UInt64): Boolean;
    function  RunRemoteCallEx(FuncVA: UInt64; ArgRcx, ArgRdx, ArgR8, ArgR9: UInt64;
...
function  TFakeMemTarget.RunMethodCall(FuncVA: UInt64; const ArgValues: array of UInt64; const ArgIsFloat: array of Boolean; out RaxResult, Xmm0Low: UInt64): Boolean; begin RaxResult := 0; Xmm0Low := 0; Result := False; end;
function  TFakeMemTarget.RunRemoteCallEx(FuncVA: UInt64; ArgRcx, ArgRdx, ArgR8, ArgR9: UInt64; out RaxResult, Xmm0Low: UInt64): Boolean; begin RaxResult := 0; Xmm0Low := 0; Result := False; end;
